...
function PowerRateCard({ price, label }) {
    return (
        <div className='p-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/4'>
            <div className='p-4 bg-light-background dark:bg-dark-background border border-light-line dark:border-dark-line rounded-lg flex flex-col gap-2 justify-center items-center'>
